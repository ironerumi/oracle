...
(live ? describe : describe.skip)("Perplexity live smoke", () => {
  ...
  it("sonar returns response with usage", async () => {
    try {
  ...
  it("sonar-pro returns response with usage", async () => {
    try {
      const result = await runOracle(
        {
  ...
  it("sonar-reasoning-pro returns response with usage", async () => {
    try {
      const result = await runOracle(
        {
  ...
  it("sonar-deep-research returns response with usage", async () => {
    try {
      const result = await runOracle(
        {
  ...
  it("cost is extracted from API response", async () => {
    try {
      const result = await runOracle(
        {
