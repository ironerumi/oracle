...
- **`isBrowserCompatible()`**: Expanded in **two locations** (`src/cli/runOptions.ts:60` and `bin/oracle-cli.ts:992`) to include `sonar*`. Additive change -- existing gpt-_/gemini_ checks unchanged.
